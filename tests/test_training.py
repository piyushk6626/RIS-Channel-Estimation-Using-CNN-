...
from ris_training.trainer import least_squares_predictions, run_training_suite
...
def _write_tiny_dataset(root: Path, *, pilot_length: int = 8, bs_antennas: int = 4, ris_elements: int = 6) -> None:
